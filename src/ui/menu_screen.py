...
class MenuScreen:
    def __init__(self, root, stay_on_screen, go_to_login_screen, go_to_insert_units_screen, go_to_insert_leases_screen, go_to_statistics_screen):
        self._root = root
        self._frame = None
    ...
    def initialize(self):
        ...
        get_statistics_button.grid(row=3, column=2)
